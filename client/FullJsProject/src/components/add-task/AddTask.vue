...
let topicsList: Ref<TopicsData[]> = ref([
  {
    id: 1,
    topicName: 'Work'
  },
    ...
    <form action="" class="h-full flex flex-col">
      <div class="mb-6">
        ...
        <input
          ...
          :placeholder="$t('app.add-task-sidebar.task-name-placeholder')"
          required
        />
      </div>
      <div class="mb-6">
        ...
        <textarea
          ...
          :placeholder="$t('app.add-task-sidebar.task-description-placeholder')"
        ></textarea>
      </div>
      <div class="mb-6 flex w-full">
        <div class="w-1/2">
          <label
            for="select-task-topic"
            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
          >
            {{ $t('app.add-task-sidebar.task-topic-label') }}</label
          >
          <select
            id="select-task-topic"
            required
        ...
        <div class="w-1/2">
          <label
            for="select-priority-level"
            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white w-11/12"
          >
      ...
      <div class="flex space-x-0 justify-evenly mt-auto">
        <button
          @click="$emit('hideTaskSidebar', false)"
          type="button"
        ...
        >
          {{ $t('app.add-task-sidebar.cancel-task-button') }}</button
        ><button
          type="submit"
