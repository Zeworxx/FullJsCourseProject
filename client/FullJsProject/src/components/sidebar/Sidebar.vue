  ...
  >
    <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
      ...
      <div class="flex flex-col mt-5 p-2">
        ...
        <div class="flex px-2 py-2 flex-row mb-3 items-center hover:cursor-pointer rounded hover:bg-slate-200" v-for="userTopic in userTopicsData" :key="userTopic.id">
          <div class="w-5 h-5 rounded-xl bg-amber-200"></div>
          <span class="ml-3">{{ userTopic.topicName }}</span>
          <span class="ml-auto bg-gray-200 text-gray-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-gray-400 ">1</span>
        </div>
      </div>
    </div>
  </aside>
